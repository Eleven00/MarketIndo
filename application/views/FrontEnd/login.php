        ...
        <div class="container">
            <div class="col-md-4 content-center">
                <div class="card card-login card-plain">
                    ...
                    <form method="POST" action="<?php echo site_url('login_u/proses_login') ?>">
                    <div class="header header-primary text-center">
                        <h2>Login <b>User</b></h2>
                    </div>
                    <div class="content">
                        <div class="input-group form-group-no-border input-lg">
                            ...
                            <input type="text" class="form-control" placeholder="Username..." required oninvalid="this.setCustomValidity('Tolong masukan username anda')" oninput="setCustomValidity('')" name="username">
                        </div>
                        <div class="input-group form-group-no-border input-lg">
                            <span class="input-group-addon">
                                <i class="fa fa-lock"></i>
                            </span>
                            <input type="password" placeholder="Password..." class="form-control" required oninvalid="this.setCustomValidity('Tolong masukan password anda')" oninput="setCustomValidity('')" name="password" />
                        </div>
